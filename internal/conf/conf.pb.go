...
func (x *Data_Minio) GetPublicUrl() string {
	if x != nil {
		return x.PublicUrl
	}
	return ""
...
const file_internal_conf_conf_proto_rawDesc = "" +
	...
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	"\x04addr\x18\x02 \x01(\tR\x04addr\x123\n" +
	"\atimeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\atimeout\"\xee\x05\n" +
	"\x04Data\x125\n" +
	"\bdatabase\x18\x01 \x01(\v2\x19.kratos.api.Data.DatabaseR\bdatabase\x12,\n" +
	"\x05redis\x18\x02 \x01(\v2\x16.kratos.api.Data.RedisR\x05redis\x12,\n" +
	"\x05minio\x18\x03 \x01(\v2\x16.kratos.api.Data.MinioR\x05minio\x1a\xcd\x01\n" +
	"\bDatabase\x12\x16\n" +
	...
	"\rwrite_timeout\x18\x05 \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeout\x1a\xba\x01\n" +
	"\x05Minio\x12\x1a\n" +
	...
	"\n" +
	"public_url\x18\x06 \x01(\tR\tpublicUrl\"_\n" +
	"\x04Auth\x12\x1d\n" +
	"\n" +
